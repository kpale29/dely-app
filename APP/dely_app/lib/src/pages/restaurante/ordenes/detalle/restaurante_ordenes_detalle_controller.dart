...
class RestauranteOrdenesDetalleController {
  ...
  void updatePedido()async{
    if(idDelivery != ''){
    pedido!.idRepartidor = idDelivery;
    ResponseApi? responseApi = await pedidosProvider.actualizarDespachado(pedido!);
    if(responseApi != null){
      Fluttertoast.showToast(msg: responseApi.message as String, toastLength: Toast.LENGTH_LONG );  
      Navigator.pop(context!,true);
    }
    }else{
      Fluttertoast.showToast(msg: 'Debe seleccionar un repartidor');
    }
  }
