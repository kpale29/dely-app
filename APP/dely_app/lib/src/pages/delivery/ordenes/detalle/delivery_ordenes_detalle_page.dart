...
class DeliveryOrdenesDetallePage extends StatefulWidget {
  Pedido pedido;
  DeliveryOrdenesDetallePage({Key? key, required this.pedido}) : super(key: key);

  @override
  _DeliveryOrdenesDetallePageState createState() => _DeliveryOrdenesDetallePageState();
}


class _DeliveryOrdenesDetallePageState extends State<DeliveryOrdenesDetallePage> {

  DeliveryOrdenesDetalleController _con = new DeliveryOrdenesDetalleController();
  @override
  void initState() {
    super.initState();
